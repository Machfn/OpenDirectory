...
Option #1 => Use this install script **coming soon** <br \>
Option #2: <br \>
    Steps: <br \>
        ...
        5. Add the path of the folders you want to have available on your webserver to the whitelist (make sure you give the root directory! Look at the examples!) <br \>
